...
class CSphericalJointTestSample : public PhysXSample
	, public PxSimulationEventCallback
{
public:
	CSphericalJointTestSample(PhysXSampleApplication& app);
	virtual ~CSphericalJointTestSample();
...
inline PxU32 CSphericalJointTestSample::getDebugObjectTypes() const {
	return DEBUG_OBJECT_BOX | DEBUG_OBJECT_SPHERE | DEBUG_OBJECT_CAPSULE | DEBUG_OBJECT_CONVEX;
}

inline Picking* CSphericalJointTestSample::GetPicking() { return mPicking; }
